...
export ZSH="/home/akashiyachime/.oh-my-zsh"
...
alias rdp='rdesktop -f -a 16 -r disk:home=/home -u administrator -p nekoSTU.top123 124.221.168.47'
alias lg='lazygit'
alias x='axel'
alias update='yay -Syu'
alias n='ncdu'
alias d='duf'
alias token='xclip -i ~/forVSCode/MyBlog/token.txt'
alias s='neofetch'
...
export FZF_DEFAULT_COMMAND='ag --hidden --ignore={.git,node_modules,build,.vscode,pkg,.themes} -g ""'
export FZF_COMPLETION_TRIGGER='\'
export FZF_TMUX=1
export FZF_TMUX_HEIGHT='80%'
# need ccat
export FZF_REVIEW_COMMAND='[[ $(file --mime {}) =~ binary ]] && echo {} is a binary file || (ccat --color=always {} || highlight -O ansi -l {} || cat {}) 2> /dev/null | head -500'

source ~/.config/zsh/completion.zsh
source ~/.config/zsh/tab/fzf-tab.plugin.zsh
...
# alias ohmyzsh="mate ~/.oh-my-zsh"j
