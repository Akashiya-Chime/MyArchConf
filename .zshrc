...
# export FZF_DEFAULT_COMMAND='ag --hidden --ignore={.git,node_modules,build,.vscode,pkg} -g ""'
export FZF_DEFAULT_COMMAND='fd --hidden --follow -E ".git" -E ".vscode" -E "node_modules" -E "build pkg" -E ".themes" -E ".wine" --type f'
